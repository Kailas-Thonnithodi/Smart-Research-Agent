...
### 🌐 Live Demo
Try it out on [Hugging Face 🤗](https://img.shields.io/badge/%F0%9F%A4%97%20Model-Hugging%20Face-yellow)][click me](https://huggingface.co/spaces/GoldenMeta/Smart-Research-Agent). If you are interested in local development of the agents, you can follow the instructions folder. 
